...
import { createCasa, deleteCasa, getCasaById, listCasas, updateCasa, } from "../controllers/casas.controller.js";
export const casasRouter = Router();
casasRouter.get("/", requireAuth, listCasas);
casasRouter.get("/:id", requireAuth, getCasaById);

...
import { createAtuador, deleteAtuador, getAllAtuadores, getAtuadorById, patchAtuador, } from "../controllers/atuadores.controller.js";
...
atuadoresRouter.post("/", requireAuth, requireAdmin, validateRequiredBody(["nome", "tipo_atuador", "localizacao", "estado", "Tipos_classe", "Tipos_tipo"]), createAtuador);

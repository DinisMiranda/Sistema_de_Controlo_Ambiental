...
import { createSensor, deleteSensor, getAllSensores, getLatestReading, getSensorById, patchSensor, } from "../controllers/sensores.controller.js";
...
sensoresRouter.post("/", requireAuth, requireAdmin, validateRequiredBody([
    "nome",
    "tipo_sensor",
    "localizacao",
    "estado",

CREATE DATABASE IF NOT EXISTS sistema_controlo_ambiental;
USE sistema_controlo_ambiental;
...
CREATE TABLE parametros_automaticos (
    ...
    CONSTRAINT fk_parametros_admin
...
CREATE INDEX idx_alertas_timestamp
    ON alertas(timestamp_alerta);
